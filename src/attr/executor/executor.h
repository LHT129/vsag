...
public:
    static ExecutorPtr
    MakeInstance(const ExprPtr& expression, const AttrInvertedInterfacePtr& attr_index);

    Executor(const ExprPtr& expression, const AttrInvertedInterfacePtr& attr_index)
        : expr_(expression), attr_index_(attr_index) {};
