...
static const std::unordered_map<std::string, std::vector<std::string>> EXTERNAL_MAPPING = {
    ...
    {IVF_BASE_IO_TYPE, {BUCKET_PARAMS_KEY, IO_PARAMS_KEY, IO_TYPE_KEY}},
    {IVF_BUCKETS_COUNT, {BUCKET_PARAMS_KEY, BUCKETS_COUNT_KEY}},
};
...
IVF::IVF(const IVFParameterPtr& param, const IndexCommonParam& common_param)
    ...
    this->bucket_ = BucketInterface::MakeInstance(param->bucket_param_, common_param);
