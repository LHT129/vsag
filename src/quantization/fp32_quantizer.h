...
public:
    explicit FP32Quantizer(int dim, const std::shared_ptr<SafeAllocator>& allocator);
...
template <MetricType metric>
FP32Quantizer<metric>::FP32Quantizer(int dim, const std::shared_ptr<SafeAllocator>& allocator)
