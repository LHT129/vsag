...
public:
    explicit SQ4Quantizer(int dim, const std::shared_ptr<SafeAllocator>& allocator);
...
SQ4Quantizer<metric>::SQ4Quantizer(int dim, const std::shared_ptr<SafeAllocator>& allocator)
