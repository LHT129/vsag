...
public:
    /**
     * @brief Retains shared ownership of a named pair; lvalue arguments are copied, not consumed.
     ...
     * Inserting other names (including rehash) preserves this pointer. Destroying or assigning
     * the owning set invalidates it; copy the pair to retain independent shared ownership.
     */
